...
@section('content')
<div class="py-24 bg-zinc-950 min-h-screen relative overflow-hidden flex items-center justify-center">
    ...
    <div class="max-w-2xl mx-auto px-6 lg:px-8 relative z-10 w-full">
        <div class="card-glass rounded-xl p-10 md:p-16 relative overflow-hidden border-zinc-800 shadow-2xl text-center">
            ...
            <h1 class="text-3xl md:text-4xl font-serif font-bold text-white mb-4">Manifest Secured</h1>
            
            <p class="text-zinc-400 text-lg mb-8 max-w-md mx-auto">
                Your service request has been logged. Please securely bag your garments and provide this reference code to your concierge.
            </p>

            <div class="bg-zinc-900/80 border border-zinc-800 rounded-lg p-6 mb-10 inline-block w-full max-w-sm">
                <p class="text-xs font-bold uppercase tracking-widest text-zinc-500 mb-2">Invoice Code</p>
